...
public class DlgPoint extends JDialog {
			...
			getContentPane().add(butttonsPanel, BorderLayout.SOUTH);
			{
				...
				btnConfirm.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent click) {
						if (txtX.getText().isEmpty() || txtY.getText().isEmpty()) JOptionPane.showMessageDialog(getParent(), "Values cannot be empty!", "Error", JOptionPane.ERROR_MESSAGE);
						else {
							try {	
	...
	public void write(Point point,int drawWidth, int drawHeight) {
		txtX.setText(String.valueOf(point.getXcoordinate()));
		txtY.setText(String.valueOf(point.getYcoordinate()));
