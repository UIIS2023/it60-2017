...
public class DlgHexagon extends JDialog {
            ...
            getContentPane().add(buttonsPanel, BorderLayout.SOUTH);
            {
                ...
                btnConfirm.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent click) {
                        if (txtX.getText().isEmpty() || txtY.getText().isEmpty() || txtRadius.getText().isEmpty()) JOptionPane.showMessageDialog(getParent(), "Values cannot be empty!", "Error", JOptionPane.ERROR_MESSAGE);
                        else {
                            try {
    ...
    public void fillUp(HexagonAdapter hexagon, int drawWidth, int drawHeight) {
    	txtX.setText(String.valueOf(hexagon.getXcoordinate()));
    	txtY.setText(String.valueOf(hexagon.getYcoordinate()));
